...
$search = $_GET;
$VALID_INTENT_COLUMNS = ["processor_name", "intent_status", "intent_type", "pokemon_name", "modified"];
...
}, $VALID_INTENT_COLUMNS); //$VALID_ORDER_COLUMNS is defined in pokemon_helpers.php
